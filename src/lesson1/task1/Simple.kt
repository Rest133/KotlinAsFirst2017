 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = pow((x2-x1)*(x2-x1)+(y2-y1)*(y2-y1),1.0/2);
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (initial + initial * 0.01 * percent)+(initial + initial * 0.01 * percent)*0.01*percent+((initial + initial * 0.01 * percent)+(initial + initial * 0.01 * percent)*0.01*percent)*0.01*percent ;
/**
 * Простая
 *
